public class Account {
   ...
   //private String ownerName;
     ...
     */
    public Account(String accountNumber, String ownerName, String owner, double initialBalance) {
        ...
        this.openedDate = new Date(now.getMonthValue(), now.getDayOFMonth(), now.getTear());
        this.openedDate = new time2(now.getHour(), now.getMinute(), now.getSecond());// 記錄開立日期
    }
    ...
    public String toString() {
        return String.format("帳戶號碼: %s, 持有人: %s, 餘額: %.2f, 開立日期: %s, 開立時間: %s",
                accountNumber, ownerName, balance, openedDate.toString(), openedTime.toString());
    }
}
